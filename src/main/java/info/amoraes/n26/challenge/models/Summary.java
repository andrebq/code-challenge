...
public class Summary {
     ...
     *
     * merge(a, merge(b, merge(c, d))) is equals to
     * merge(b, merge(c, merge(d, b))) and so on
     *
     * With this property, given a unordered set of unique summaries,
     * a final summary can be obtained regardless how the summaries are merged
     * @param a
     * @param b
     * @return
     */
    ...
    public static class SummaryBuilder {
        ...
        /**
         * merge the given summary into the current one,
         * updating the required fields as needed
         * @param s
         * @return
         */
        ...
        public Summary from(Transaction t) {
            return this.max(t.getAmount()).min(t.getAmount()).count(1).avg(t.getAmount()).sum(t.getAmount()).build();
        }
